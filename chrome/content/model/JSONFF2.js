 ...
 * 
 * The Initial Developer of the Original Code is Simon B�nzli <zeniko@gmail.com> Portions created by
 * the Initial Developer are Copyright (C) 2006-2007 the Initial Developer. All Rights Reserved.
 * 
 * Contributor(s):
 * 
...
/**
 * Utilities for JavaScript code to handle JSON content. See http://www.json.org/ for comprehensive
 ...
 * Usage:
 * 
 * var newJSONString = JSONFF2.encode( GIVEN_JAVASCRIPT_OBJECT ); var newJavaScriptObject =
 * JSONFF2.decode( GIVEN_JSON_STRING );
 * 
 * Note: For your own safety, Objects/Arrays returned by JSON.fromString aren't instanceof
 * Object/Array.
 */

var EXPORTED_SYMBOLS = [ "JSONFF2" ];
...
// * An optional key blacklist has been added to JSON.encode
...
var JSONFF2 = {
     ...
     * @param aKeysToDrop is an optional array of keys which will be ignored in all objects during
     *        the serialization
     * @return the object's JSON representation
     * 
     * Note: aJSObject MUST not contain cyclic references.
     */
    encode : function JSON_toString ( aJSObject, aKeysToDrop) {
        ...
        function append_piece (aObj) {
            ...
            else if (aObj instanceof Array || typeof aObj == "object" && "length" in aObj
     ...
     */
    decode : function JSON_fromString ( aJSONString) {
    ...
    /**
     * Checks whether the given string contains potentially harmful content which might be executed
     * during its evaluation (no parser, thus not 100% safe! Best to use a Sandbox for evaluation)
     * 
